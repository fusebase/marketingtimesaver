	...
	<div class="navbar navbar-fixed-top">
		<div class="navbar-inner">
			<div class="container-fluid">
				...
				<a class="brand" href="/"><span><img style="margin:-6px 0 0; max-height:24px;" src="/assets/components/mts/images/marketing_timesaver_3_reverse_qorqdg.png"></span></a>
				...
				<div class="nav-no-collapse header-nav">
					<ul class="nav pull-right">
						...
						<li class="dropdown">
							<a class="btn dropdown-toggle" data-toggle="dropdown" href="#">
								<i class="halflings-icon white user"></i> Nathan Fitzgerald
								<span class="caret"></span>
							</a>
							<ul class="dropdown-menu">
								<li><a href="#"><i class="halflings-icon white user"></i> Profile</a></li>
								<li><a href="#"><i class="halflings-icon white user"></i> Account</a></li>
